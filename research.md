...
<p class="page-intro">
We use human genetics and immunology to discover mechanisms of immune defense and dysregulation,
...
<div class="research-grid research-grid-3">
  ...
  <a href="{{ '/research/novel-iei' | relative_url }}" class="research-card">
    ...
    <div class="research-card-body">
      ...
      <p>
        Discovering and characterizing new inborn errors of immunity underlying severe infection,
  ...
  <a href="{{ '/research/therapeutics' | relative_url }}" class="research-card">
    ...
    <div class="research-card-body">
      ...
      <p>
        Building precision therapeutic strategies informed by human genetics, including targeted
        immunomodulation and translational pathways to intervention.
      </p>
      <span class="research-link">Learn more →</span>
    </div>
  </a>
